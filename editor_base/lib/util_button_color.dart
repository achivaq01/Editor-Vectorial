...
class UtilButtonColorState extends State<UtilButtonColor> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTapDown: !widget.enabled ? null : (details) => setState(() => _isPressed = true),
      onTapUp: !widget.enabled ? null : (details) => setState(() => _isPressed = false),
                ...
                child: Align(
                  ...
                  child: SizedBox(
                    ...
                    child: IconTheme(
                      ...
                      child: Icon(CupertinoIcons.chevron_down, color: colorIcon),
                    ),
                  ),
                ),
              ),
